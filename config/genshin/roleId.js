...
let roleId = {
  ...
  10000015: ["凯亚","盖亚","凯子哥","凯鸭","矿工","矿工头子","骑兵队长","凯子","凝冰渡海真君"],
  ...
  10000056: ["九条裟罗", "九条", "九条沙罗", "裟罗", "沙罗","天狗"],
  10000062: ["埃洛伊"],
  10000050: ["托马", "家政官", "太郎丸", "地头蛇","男仆","拖马"],
  10000055: ["五郎","柴犬","土狗","希娜","希娜小姐"],
  10000057: ["荒泷一斗","荒龙一斗","荒泷天下第一斗", "一斗", "一抖","荒泷","1斗","牛牛","斗子哥","牛子哥","牛子","孩子王","斗虫","巧乐兹"],
  10000058: ["八重神子","八重","神子","狐狸","想得美哦","巫女","屑狐狸","骚狐狸","八重宫司","婶子","小八"],
  10000063: ["申鹤", "神鹤","小姨","小姨子","审鹤"],
  10000064: ["云堇","云瑾","云先生","云锦","神女劈观"],
  10000066: ["神里绫人","绫人","神里凌人","凌人","0人","神人"],
...
//活动武器
let actWeapon = ["腐殖之剑","风花之颂","嘟嘟可故事集","「渔获」","辰砂之纺锤","证誓之明瞳"];
...
let todayList = [
  {
    "诗文": ["蒙德",["温迪", "阿贝多", "菲谢尔", "罗莎莉亚", "凯亚", "丽莎"],true],
    "黄金": ["璃月",["钟离", "行秋", "烟绯", "北斗", "辛焱"],true],
    "天光": ["稻妻",["八重神子", "雷电将军", "五郎", "早柚"],true],
    "狮牙斗士": ["蒙德",["阿莫斯之弓","苍古自由之誓","天空之脊","狼的末路","四风原典","宗室大剑","西风猎弓","宗室长弓","祭礼剑","西风大剑","西风长枪","腐殖之剑","忍冬之果","风花之颂","暗巷猎手","祭礼残章"],false],
    "漆黑陨铁": ["璃月",["护摩之杖","尘世之锁","贯虹之槊","万国诸海图谱","试作古华","铁峰刺","试作星镰","钢轮弓","螭骨剑","千岩长枪"],false],
    "今昔剧画": ["稻妻",["神乐之真意","薙草之稻光","冬极白星","渔获","断浪长鳍","喜多院十文字"],false],
  },
  {
    "自由": ["蒙德",["达达利亚", "埃洛伊", "可莉", "迪奥娜", "砂糖", "芭芭拉", "安柏"],true],
    "繁荣": ["璃月",["申鹤", "魈", "七七", "刻晴", "凝光"],true],
    "浮世": ["稻妻",["宵宫", "珊瑚宫心海", "托马"],true],
    "高塔孤王": ["蒙德",["松籁响起之时","风鹰剑","辰砂之纺锤","宗室秘法录","西风秘典","绝弦","西风剑","钟剑","宗室长剑","暗巷闪光","苍翠猎弓","雪葬的星银"],false],
    "孤云寒林": ["璃月",["和璞鸢","斫峰之刃","匣里龙吟","黑岩绯玉","白影剑","黑岩长剑","流月针","弓藏","匣里日月","黑岩战弓","千岩古剑"],false],
    "远海夷地": ["稻妻",["雾切之回光","不灭月华","证誓之明瞳","天目影打刀","白辰之环","恶玉丸"],false],
  },
  {
    "抗争": ["蒙德",["优菈", "琴", "莫娜", "迪卢克", "班尼特", "诺艾尔", "雷泽"],true],
    "勤劳": ["璃月",["甘雨", "胡桃", "枫原万叶", "香菱", "重云", "云堇"],true],
    "风雅": ["稻妻",["荒泷一斗", "神里绫华", "九条裟罗", "神里凌人"],true],
    "凛风奔狼": ["蒙德",["终末嗟叹之诗","天空之翼","天空之卷","天空之刃","天空之傲","决斗之枪","暗巷的酒与诗","流浪乐章","嘟嘟可故事集","祭礼弓","黑剑","笛剑","祭礼大剑","龙脊长枪",""],false],
    "雾海云间": ["璃月",["磐岩结绿","息灾","无工之剑","试作金珀","匣里灭辰","试作澹月","宗室猎枪","黑岩刺枪","试作斩岩","雨裁","黑岩斩刀","昭心"],false],
    "鸣神御灵": ["稻妻",["飞雷之弦振","赤角石溃杵","曚云之月","破魔之弓","桂木斩长正",""],false],
  },
];

export { roleId , wifeData , abbr , abbr2 , roleId5 , roleId4 , actWeapon , costumes , todayList};
