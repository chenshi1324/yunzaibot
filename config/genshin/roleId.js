...
let todayList = [
  {
    "诗文": ["蒙德",["温迪", "阿贝多", "菲谢尔", "罗莎莉亚", "凯亚", "丽莎"]],
    "黄金": ["璃月",["钟离", "行秋", "烟绯", "北斗", "辛焱"]],
    "天光": ["稻妻",["八重神子", "雷电将军", "五郎", "早柚"]],
  },
  {
    "自由": ["蒙德",["达达利亚", "埃洛伊", "可莉", "迪奥娜", "砂糖", "芭芭拉", "安柏"]],
    "繁荣": ["璃月",["申鹤", "魈", "七七", "刻晴", "凝光"]],
    "浮世": ["稻妻",["宵宫", "珊瑚宫心海", "托马"]],
  },
  {
    "抗争": ["蒙德",["优菈", "琴", "莫娜", "迪卢克", "班尼特", "诺艾尔", "雷泽"]],
    "勤劳": ["璃月",["甘雨", "胡桃", "枫原万叶", "香菱", "重云", "云堇"]],
    "风雅": ["稻妻",["荒泷一斗", "神里绫华", "九条裟罗", "神里凌人"]],
  },
];
