...
export const rule = {
  ...
  todayQuery: {
    reg: "^#(今日素材|素材|今日材料|材料)[角色]*[信息]*[ |0-9]*$",
    priority: 208,
    describe: "【#今日素材】查看今天可以刷什么角色的",
  },
};

for (let val of ["abyss", "abyssFloor", "character", "character2", "life", "role", "roleAll", "weapon", "roleCard", "todayQuery"]) {
  //创建html文件夹
...
export async function todayQuery(e) {
  ...
  let todayList = [
    {
      "诗文": ["阿贝多", "菲谢尔", "罗莎莉亚", "凯亚", "丽莎"],
      "黄金": ["钟离", "温迪", "行秋", "烟绯", "北斗", "辛炎"],
      "天光": ["八重神子", "雷电将军" , "五郎", "早柚"],
    },
    {
      "自由": ["达达利亚", "埃洛伊", "可莉", "迪奥娜", "砂糖", "芭芭拉", "安柏"],
      "繁荣": ["申鹤", "魈", "七七", "刻晴", "凝光"], 
      "浮世": ["宵宫", "珊瑚宫心海", "托马"],
    },
    {
      "抗争": ["优菈", "琴", "莫娜", "迪卢克", "班尼特", "诺艾尔", "雷泽"],
      "勤劳": ["甘雨", "胡桃", "枫原万叶", "香菱", "重云", "云堇"],
      "风雅": ["荒泷一斗", "神里凌华", "九条裟罗", "神里凌人"],
    },
  ];

  let nowElement = todayList[week%3];
  let mainList = [];
