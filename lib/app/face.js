...
async function get(e) {
  ...
  let face = faceArr[group_id].get(e.msg);
  ...
  let img = `/data/face/${group_id}/${e.msg}.${face.suffix}`;
...
//根据关键词随机获取表情
async function getRandomImg(keyWord) {
...
async function atRandom(e) {
  ...
  Bot.logger.mark(`斗图:${e.group_name}：${e.msg}`);
