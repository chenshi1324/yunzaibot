...
export async function update(e) {
  ...
  //更新抽卡统计卡池
  await common.downFile("/config/genshin/pool/200.json");
  await common.downFile("/config/genshin/pool/301.json");
  await common.downFile("/config/genshin/pool/302.json");

  YunzaiApps.gacha.init(true);
  YunzaiApps.gachaLog.init(true);
  YunzaiApps.gachaLog.init(true);
