...
async function gacha(e) {
  ...
  if (!e.isMaster && count[end.dayEnd][user_id] && count[end.dayEnd][user_id] > Number(dayNum) + 2) {
  ...
  if (gachaData.today.num >= dayNum && !e.isMaster) {
  ...
  if (up5.length <= 0) {
    ...
    upW4 = gachaConfig.pool[gachaConfig.pool.length - 1].weapon4;
