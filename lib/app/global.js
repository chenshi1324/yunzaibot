...
/**
 * 全局表情，表情图片放到resources/全局表情
 * 全局语音，语音文件放到resources/全局语音
...
//获取所有资源文件
function init() {
  readdirectory("./resources/全局表情", "img");
  watchFile("./resources/全局表情", "img");
  readdirectory("./resources/全局语音", "record");
  watchFile("./resources/全局语音", "record");
}
